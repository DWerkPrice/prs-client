...
export class ProductService {
  ...
  create(product: Product): Observable<Product>{ // added this function
    return this.http.post(`${url}`, product) as Observable<Product>;
  }
  change(product: Product): Observable<any>{ // added this function
    return this.http.put(`${url}/${product.id}`, product) as Observable<Product>;
  }
  remove(product: Product): Observable<any>{ // added this function
